...
const Toast = (props: ToastProps) => {
  ...
  const toastsHeightBefore = createMemo(() =>
    props.heights.reduce((prev, curr, reducerIndex) => {
  ...
  createEffect(() => {
    ...
    if (props.expanded || props.interacting || (pauseWhenPageIsHidden && isDocumentHidden())) {
      pauseTimer();
    } else {
      startTimer();
    }
  ...
  return (
    ...
    >
      <Show when={!toast.jsx} fallback={toast.jsx}>
